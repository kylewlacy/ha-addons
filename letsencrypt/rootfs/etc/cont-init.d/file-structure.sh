...
echo -e "dns_cloudxns_api_key = $(bashio::config 'dns.cloudxns_api_key')\n" \
      ...
      "certbot_dns_namecheap:dns_namecheap_username = $(bashio::config 'dns.namecheap_username')\n"
      "certbot_dns_namecheap:dns_namecheap_api_key = $(bashio::config 'dns.namecheap_api_key')\n"
